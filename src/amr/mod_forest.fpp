...
module mod_forest
   ...
   type tree_node
      integer :: ig1,ig2,ig3 !< Spatial indices of the grid block
      ...
      type(tree_node_ptr) :: child(2,2,2) !< Pointer to children
      type(tree_node_ptr) :: neighbor(2,3) !< Pointer to neighbors
