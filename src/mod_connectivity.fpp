...
module mod_connectivity
   ...
   type nbinfo_cf_t
      integer                            :: nigrids=0
      integer, pointer, dimension(:) :: igrid => null(), inc1 => null(), inc2 => null(), inc3 => null(), isize => null()
      integer, pointer, dimension(:) :: i1 => null(), i2 => null(), i3 => null(), ibuf_start => null()
    contains
