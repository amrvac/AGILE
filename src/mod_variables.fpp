module mod_variables
  ...
  !$omp declare target(start_indices)
  ...
  !$omp declare target(stop_indices)
  ...
  !$omp declare target(iw_equi_rho, iw_equi_p)
...
contains
  ...
  function var_set_fluxvar(name_cons, name_prim, ix, need_bc) result(iw)
   ...
   !$omp target update to(nwflux, nw, nwfluxbc)
  ...
  function var_set_extravar(name_cons, name_prim, ix) result(iw)
   ...
   !$omp target update to(nwextra,nw)
  ...
  function var_set_rho() result(iw)
    ...
    !$omp target update to(nwflux,nw,nwfluxbc,iw_rho)
  ...
  function var_set_momentum(ndir) result(iw)
    ...
    !$omp target update to(nwflux,nw,nwfluxbc,iw_mom)
  ...
  function var_set_energy() result(iw)
    ...
    !$omp target update to(nwflux,nw,nwfluxbc,iw_e)
  ...
  function var_set_q() result(iw)
    ...
    !$omp target update to(nwflux,nw,nwfluxbc,iw_q)
  ...
  function var_set_radiation_energy() result(iw)
    ...
    !$omp target update to(nwflux,nw,nwfluxbc,iw_r_e)
  ...
  function var_set_bfield(ndir) result(iw)
   ...
   !$omp target update to(nwflux,nw,nwfluxbc,iw_mag)
