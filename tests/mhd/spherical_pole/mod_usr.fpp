...
!> solution. Written in spherical components both vectors are non-trivial
!> functions of theta and phi, so keeping this state uniform exercises every
!> curvilinear flux, and the induction equation and the GLM psi besides.
!>
